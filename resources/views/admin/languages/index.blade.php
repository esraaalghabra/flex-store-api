                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                                ...
                                                                <a href="{{route('admin.languages.status',$language -> id)}}" class="btn btn-outline-warning btn-min-width box-shadow-3 mr-1 mb-1">
                                                                    @if($language -> active == 0)تفعيل@elseالغاء تفعيل@endif
                                                                </a>
                                                            </div>
                                                        </td>
                                                    </tr>
